...
Slack and Telegram are the primary hosted channels. Discord stays experimental until final reply visibility is verified end to end. Hosted WhatsApp is disabled; use local/upstream OpenClaw's linked-device transport.
